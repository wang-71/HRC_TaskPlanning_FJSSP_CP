...
The lower part, highlighted by the blue dashed boundary, presents a CP-based optimization model for task allocation and sequencing. The task classification outcomes and task dependencies are encoded as constraints, while the processing times for humans and robots and human fatigue are used as input data.<img width="2368" height="853" alt="image" src="https://github.com/user-attachments/assets/cd70e596-b928-47d1-8ac9-efee7dd4d0cd" />
...
<img width="2762" height="2216" alt="image" src="https://github.com/user-attachments/assets/3f37e286-291f-4723-a450-9c6361e514f2" />
